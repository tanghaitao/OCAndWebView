...
- (void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    self.jsContext[@"getImage"] = ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            strongSelf.imagePicker = [[UIImagePickerController alloc] init];
            strongSelf.imagePicker.delegate = self;
            strongSelf.imagePicker.allowsEditing = YES;
            strongSelf.imagePicker.sourceType = UIImagePickerControllerSourceTypePhotoLibrary;
            [strongSelf presentViewController:strongSelf.imagePicker animated:YES completion:^{
                NSLog(@"打开了");
            }];
        });
